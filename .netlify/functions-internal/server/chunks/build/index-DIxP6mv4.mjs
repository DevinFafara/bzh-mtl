...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  mainImage
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container mx-auto p-4 md:p-8" }, _attrs))}><h1 class="text-2xl md:text-4xl font-bold mb-8">Tous les Articles</h1>`);
      if (unref(posts) && unref(posts).length > 0) {
        ...
        _push(`<div class="text-center py-16"><p class="text-xl text-gray-500">Aucun article disponible pour le moment.</p><p class="mt-2 text-gray-400">Revenez bient\xF4t !</p></div>`);
      }
      _push(`</div>`);
    };
  }
...
//# sourceMappingURL=index-DIxP6mv4.mjs.map
