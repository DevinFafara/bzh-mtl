<!-- pages/chroniques/album-review.vue -->
<script setup lang="ts">
// 1. La requête GROQ pour récupérer TOUS les posts où articleType est 'album-review'
...
<template>
  <div class="container mx-auto p-4 md:p-8">
    <h1 class="text-2xl md:text-4xl font-bold mb-8">Album reviews</h1>
    <p class="text-lg text-gray-600 mb-12">Revues des albums de la scène metal.</p>
    ...
    <!-- Message si aucune album-review n'est trouvée -->
    <div v-else class="text-center py-16 bg-gray-50 rounded-lg">
      <p class="text-lg text-gray-700">Aucun Album Review trouvé pour le moment.</p>
