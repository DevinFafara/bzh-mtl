...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  "author": author->name
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container mx-auto p-4 md:p-8" }, _attrs))}><h1 class="text-2xl md:text-4xl font-bold mb-8">Interviews</h1><p class="text-lg text-gray-600 mb-12">Rencontres et discussions avec les acteurs de la sc\xE8ne metal.</p>`);
      if (unref(posts) && unref(posts).length > 0) {
        ...
        _push(`<div class="text-center py-16 bg-gray-50 rounded-lg"><p class="text-lg text-gray-700">Aucune interview trouv\xE9e pour le moment.</p><p class="text-gray-500 mt-2">Revenez bient\xF4t !</p></div>`);
      }
      _push(`</div>`);
    };
  }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/chroniques/interviews.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=interviews-B-cgS3Gm.mjs.map
